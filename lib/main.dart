      ...
      theme: ThemeData(
          ...
          appBarTheme: AppBarTheme(
            textTheme: ThemeData.light().textTheme.copyWith(
                title: TextStyle(fontFamily: 'OpenSans', fontSize: 18, fontWeight: FontWeight.bold), button: TextStyle(color: Colors.white)),
...
class _MyHomePageState extends State<MyHomePage> {
  final List<Transaction> _userTransactions = [
    // Transaction(id: 't1', title: 'Shirt', amount: 90000, date: DateTime.now()),
    // Transaction(id: 't2', title: 'New Phone', amount: 30000, date: DateTime.now())
  ];
